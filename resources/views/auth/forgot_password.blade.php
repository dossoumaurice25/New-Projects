...
<head>
  ...
  <title>Mot de passe oublié - Novapulse</title>
...
<body class="">
  ...
  <div class="flex items-center justify-center min-h-screen px-4">
    <div class="w-full max-w-lg glow-card p-8 text-white">
      ...
      @error('email')
          <div class="error-alert bg-danger" style="color: red">
              {{ $message }}
          </div>
      @enderror

      <form id="loginForm" class="space-y-4" action="{{ route('password.send.code') }}" method="POST">
         @csrf
        ...
        <div class="info-box">
          <div class="flex items-start">
            <i class="bi bi-info-circle mr-3 text-blue-400 text-lg mt-1"></i>
            <div>
              <h4 class="font-semibold text-white mb-2">Instructions :</h4>
              <ul class="text-sm space-y-1">
                <li>• Enter the email address associated with your account</li>
                <li>• You will receive a reset link by email</li>
