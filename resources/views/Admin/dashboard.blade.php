...
@section('titre', 'Admin - Gestion des utilisateurs')
...
@section('content')
    ...
    <h1 class="app-page-title">Dashbord</h1>
			    
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3">Welcome, {{ auth()->user()->first_name }}!</h3>
						    <div class="row gx-5 gy-3">
						        <div class="col-12 col-lg-9"> 
							        <div>Welcome back! Your dashboard is ready - monitor new activities, validate requests and keep the platform up to date.</div>
							    </div><!--//col-->
							</div><!--//row-->
			    ...
			    <div class="row g-4 mb-4">
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Total number of godchildren</h4>
							    <div class="stats-figure">{{ $totalFilleuls }}</div>
							</div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="#"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
  ...
  <path fill-rule="evenodd" d="M15.898 2.223a3.003 3.003 0 0 1-3.679 3.674L5.878 12.15a3 3 0 1 1-2.027-2.027l6.252-6.341A3 3 0 0 1 13.778.1l-2.142 2.142L12 4l1.757.364 2.141-2.141zm-13.37 9.019L3.001 11l.471.242.529.026.287.445.445.287.026.529L5 13l-.242.471-.026.529-.445.287-.287.445-.529.026L3 15l-.471-.242L2 14.732l-.287-.445L1.268 14l-.026-.529L1 13l.242-.471.026-.529.445-.287.287-.445.529-.026z"/>
				...
				<h1 class="app-page-title mb-3">Latest users</h1>
				<div class="tab-pane "  >
					    <div class="app-card app-card-orders-table mb-5">
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table mb-0 text-left text-black">
										<thead>
											<tr>
												<th class="cell">ID</th>
												...
												@if($latestUsers->isEmpty())
													<tr>
														<td colspan="5" class="text-center py-4">
															<p class="text-muted">No users at the moment.</p>
														</td>
													</tr>
												@else
														@foreach($latestUsers as $user)
															<tr>
																...
																<td class="cell"><strong>{{ $user->username }}</strong></td>
																<td class="cell">{{ $user->first_name }}</td>
																<td class="cell"><span class="cell-data">{{ $user->last_name }}</span></td>
																<td class="cell"><a href="mailto:{{ $user->email }}">{{ $user->email }}</a></td>
															</tr>
														@endforeach
												@endif
										</tbody>
